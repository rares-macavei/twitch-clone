...
const Card = ({ title, image, viewers, type }) => {
  return (
    <div>
      <div className="h-[250px] w-auto flex mt-4 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-3 hover:scale-110 hover:bg-indigo-500 duration-200 cursor-pointer">
